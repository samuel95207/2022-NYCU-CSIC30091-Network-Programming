...
test:
	...
	@mkdir -p testing/src/311511034/src
	@cp -r src/part1-cgi testing/src/311511034/src/part1-cgi
	@cp -r src/part1-http testing/src/311511034/src/part1-http
	@cp -r src/part2 testing/src/311511034/src/part
...
zip:
	...
	@cp src/part2/Makefile 311511034/src/part2/Makefile
